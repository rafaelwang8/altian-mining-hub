...
import truckImg from "@/assets/caminhao-altian.png";
    ...
    <section id="caminhao-autonomo" className="py-20 section-padding bg-background scroll-mt-24">
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-start">
        ...
        <div className="space-y-4">
          <div className="relative overflow-hidden border border-border aspect-[5/4] bg-slate-950">
            <img src={truckImg} alt="Caminhão autônomo elétrico de mineração" className="h-full w-full object-cover" />
            ...
            <div className="absolute left-5 top-5 flex flex-wrap gap-2 md:left-6 md:top-6">
              {["Autonomia L4", "100% Elétrico", "Troca Rápida"].map((item) => (
                <span
                  key={item}
                  className="border border-white/15 bg-black/35 px-3 py-1.5 text-[11px] font-bold uppercase tracking-[0.24em] text-white backdrop-blur-sm"
                >
                  {item}
                </span>
              ))}
            ...
            <div className="absolute bottom-0 left-0 right-0 p-5 md:p-6">
              <div className="max-w-xl border border-white/10 bg-black/35 p-4 backdrop-blur-sm">
                <p className="mb-2 text-xs font-bold uppercase tracking-[0.28em] text-primary">Caminhão Autônomo Altian</p>
                <p className="text-sm leading-relaxed text-slate-100 md:text-base">
                  Plataforma elétrica com direção autônoma, percepção embarcada e arquitetura de alta disponibilidade para
                  operações contínuas de mina.
                </p>
              </div>
            </div>
