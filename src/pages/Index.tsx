...
import {
  Shield, Gauge, Wrench, ChevronRight, HardHat, Headphones, Settings,
  Truck, Zap, Eye, Brain, Radio, BatteryCharging, ArrowRight, Check,
} from "lucide-react";
...
const Index = () => {
  return (
    <Layout>
          ...
          <div className="max-w-3xl">
            <div className="flex items-center gap-3 mb-8">
              ...
              <span className="text-primary text-xs font-bold tracking-widest uppercase">
                Caminhões Autônomos Elétricos no Brasil
              </span>
            </div>

            <h1 className="font-heading text-5xl md:text-6xl lg:text-7xl font-bold text-foreground leading-[1.05] mb-8 tracking-tight">
              Tecnologia que{" "}
              <span className="text-primary">protege vidas</span>{" "}
            ...
            <p className="text-lg md:text-xl text-muted-foreground leading-relaxed mb-12 max-w-xl">
              Caminhões autônomos elétricos e sistemas inteligentes para operações de mineração de grande escala.
            </p>
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-4 -right-4 w-24 h-24 border border-border bg-background/80 flex items-center justify-center">
              <div className="text-center">
                ...
                <div className="text-xs text-muted-foreground uppercase tracking-wider">Operação</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="relative max-w-7xl mx-auto">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <div className="flex items-center justify-center gap-3 mb-6">
              <div className="h-px w-8 bg-primary" />
              <span className="text-primary text-xs font-bold tracking-widest uppercase">Sistema de Tecnologia</span>
              <div className="h-px w-8 bg-primary" />
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {[
                { icon: Gauge, label: "Direção Autônoma L4", desc: "Operação autônoma completa sem intervenção humana em rotas de mina." },
                { icon: Eye, label: "Percepção LIDAR & Radar", desc: "Mapeamento 3D em tempo real do ambiente para navegação precisa e segura." },
                { icon: Brain, label: "Tomada de Decisão por IA", desc: "Algoritmos de inteligência artificial para decisões autônomas em campo." },
                { icon: Radio, label: "Despacho Inteligente", desc: "Otimização automática de ciclos de transporte e alocação de frota." },
                { icon: Truck, label: "Operação Remota", desc: "Centro de controle remoto com visibilidade total da operação." },
                { icon: BatteryCharging, label: "Troca de Bateria", desc: "Sistema de troca instantânea para operação contínua 24/7 sem paradas." },
              ].map(({ icon: Icon, label, desc }) => (
                <div key={label} className="bg-card border border-border p-5 hover:border-primary/40 transition-colors group">
                  <Icon className="text-primary mb-3" size={20} />
                  <h3 className="font-heading text-sm font-bold text-foreground mb-1">{label}</h3>
            ...
            {[
              ...
              <div key={title} className="bg-card p-10">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    <div className="font-heading text-3xl font-bold text-primary">{metric}</div>
                    <div className="text-xs text-muted-foreground uppercase tracking-wider">{metricSub}</div>
                  </div>
                </div>
          ...
          <div className="grid lg:grid-cols-2 gap-0 border border-border">
            ...
            <div className="p-10 lg:p-14 bg-card">
              <div className="inline-flex items-center gap-2 bg-primary/10 border border-primary/30 px-3 py-1 mb-6">
                ...
                <span className="text-primary text-xs font-bold tracking-widest uppercase">Próxima Geração</span>
              </div>

              <p className="text-muted-foreground leading-relaxed mb-10">
                Projetado para operações de mineração de grande escala em minas a céu aberto. Combina alta capacidade de carga com tecnologia de condução autônoma L4 e propulsão totalmente elétrica.
              </p>
      ...
      <section className="relative section-padding overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <div className="flex items-center justify-center gap-3 mb-6">
              <div className="h-px w-8 bg-primary" />
              <span className="text-primary text-xs font-bold tracking-widest uppercase">Confiabilidade Comprovada</span>
              <div className="h-px w-8 bg-primary" />
            </div>
            <h2 className="font-heading text-4xl md:text-5xl font-bold text-foreground mb-4">
      ...
      <section className="section-padding bg-secondary relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <div className="flex items-center justify-center gap-3 mb-6">
              <div className="h-px w-8 bg-primary" />
              <span className="text-primary text-xs font-bold tracking-widest uppercase">Implementação</span>
              <div className="h-px w-8 bg-primary" />
            </div>
            <h2 className="font-heading text-4xl md:text-5xl font-bold text-foreground mb-4">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Metodologia estruturada para implantação de operações autônomas com o mínimo de impacto na operação atual.
            </p>
          </div>
      ...
      <section className="section-padding bg-background">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div>
            <div className="flex items-center gap-3 mb-6">
              <div className="h-px w-8 bg-primary" />
              <span className="text-primary text-xs font-bold tracking-widest uppercase">Suporte</span>
            </div>
            <h2 className="font-heading text-4xl md:text-5xl font-bold text-foreground leading-tight mb-8">
            ...
            <div className="space-y-4">
              {[
                { icon: HardHat, title: "Treinamento de Operadores", desc: "Capacitação técnica completa da equipe para operação dos sistemas autônomos." },
                { icon: Headphones, title: "Suporte Técnico 24/7", desc: "Time de engenharia disponível a qualquer momento para resolução de ocorrências." },
                { icon: Wrench, title: "Manutenção Preventiva e Corretiva", desc: "Programas de manutenção estruturados para maximizar a disponibilidade da frota." },
                { icon: Settings, title: "Integração com a Operação da Mina", desc: "Conexão com sistemas de gestão e despacho já utilizados na mina." },
              ].map(({ icon: Icon, title, desc }) => (
                <div key={title} className="flex items-start gap-4 p-5 bg-secondary border border-border hover:border-primary/30 transition-colors">
      ...
      <section className="relative section-padding overflow-hidden">
        <div className="absolute inset-0">
          <img src={heroImg} alt="" className="w-full h-full object-cover object-top" aria-hidden="true" />
